...
*This analysis was carried out using a professional multi-tool pipeline — Microsoft Excel, SQL Server, Power BI, Microsoft PowerPoint, and a formal Word report — demonstrating a complete end-to-end data analytics workflow. All SQL queries, Power BI dashboards, presentation slides, and source data are available as supporting materials to this report.*
